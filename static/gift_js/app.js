window.addEventListener('DOMContentLoaded', function(e) {
  ...
  var waterfall = new Waterfall({
    ...
    scaleUpbtn.addEventListener('click', function() {
        ...
        console.log(waterfall.minBoxWidth);
    });
    ...
    function newNode() {
        // data = getJSON('https://api.opensea.io/api/v1/assets?&limit=20', function(data) {
...
// window.addEventListener('DOMContentLoaded', function(e) {
//
//     var waterfall = new Waterfall({ minBoxWidth: 175 });
//
//     // button click handle
//     var btn = document.getElementById('add-btn');
//     var boxHandle = newNode();
